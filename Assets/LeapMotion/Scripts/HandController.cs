...
public class HandController : MonoBehaviour {
  ...
  public void PauseRecording() {
	...
	// rajout du chemin pour pouvoir récupérer le chemin
  public string FinishAndSaveRecording(string chemin) {
    string path = recorder_.SaveToNewFile(chemin);
    recorder_.Play();
    return path;
  }
 ...
 public void setLeapRecorder(LeapRecorder leaprecorder){
