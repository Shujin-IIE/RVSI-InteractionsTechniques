...
Getting Started:
  ...
  HandleapleapController.prefab in front of, and below the camera. The HandleapleapController
  prefab is a 'virtual' Leap Motion leapleapController. Since your real hands appear
  above the real Leap Motion leapleapController, the virtual hands will appear above
  the virtual HandleapleapController prefab. You can scale the leapleapController to change
  how big and how far the hands appear from the HandleapleapController prefab.

  If you want to get started hitting boxes around a room, the
  leapleapControllerSandBox.prefab might be a good place to start. It is a closed off
...
Customizing Hands:
  There are two HandModel fields in the HandleapleapController prefab
...
Tools:
  ...
  HandleapleapController's ToolModel parameter. There are currently two tools shipped
...
Head Mounted Displays:
  ...
  the HandleapleapController prefab as a child of the main camera facing forward.
